...
def playground_part2(input_path) -> int:
    ...
    while i < len(sorted_distances):
        ...
        # Check if the clusters have been joined together to 1 single big cluster
        if len(circuit_clusters) == 1 and len(circuit_clusters[0]) == len(circuits):
            return int(circuits[c1][0]) * int(circuits[c2][0])
...
def main():
    ...
    # input_path = "/Users/alessandrocaula/Documents/Devs/Git-Repos/ProgrammingAlgoAndChallenges/Advent_of_Code_2025/Day_8/input_test.txt"
