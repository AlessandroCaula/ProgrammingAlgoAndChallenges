...
const App = () => {
  ...
  return (
    <div className="App">
      ...
      {/*Let's do the count for using the react State*/}
      <CounterComponent/>
...
const CounterComponent = () => {
  ...
  const [counter, setCounter] = useState(0); // Calling the useState as a function. Whenever you call something as a function and you use the "use" in React is called hook.
